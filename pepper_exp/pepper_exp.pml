...
<Package name="pepper_exp" format_version="4">
    <Manifest src="manifest.xml" />
    <BehaviorDescriptions>
        <BehaviorDescription name="behavior" src="yoga_1" xar="behavior.xar" />
        ...
        <BehaviorDescription name="behavior" src="exc" xar="behavior.xar" />
        <BehaviorDescription name="behavior" src="prd" xar="behavior.xar" />
        <BehaviorDescription name="behavior" src="min" xar="behavior.xar" />
        <BehaviorDescription name="behavior" src="say" xar="behavior.xar" />
        <BehaviorDescription name="behavior" src="thk" xar="behavior.xar" />
        <BehaviorDescription name="behavior" src="okay" xar="behavior.xar" />
        <BehaviorDescription name="behavior" src="ult_2" xar="behavior.xar" />
        <BehaviorDescription name="behavior" src="ult_3" xar="behavior.xar" />
        <BehaviorDescription name="behavior" src="great_1" xar="behavior.xar" />
        <BehaviorDescription name="behavior" src="great_2" xar="behavior.xar" />
        <BehaviorDescription name="behavior" src="now" xar="behavior.xar" />
        <BehaviorDescription name="behavior" src="last" xar="behavior.xar" />
        <BehaviorDescription name="behavior" src="hello" xar="behavior.xar" />
        <BehaviorDescription name="behavior" src="wonder" xar="behavior.xar" />
        <BehaviorDescription name="behavior" src="second" xar="behavior.xar" />
        <BehaviorDescription name="behavior" src="bye_1" xar="behavior.xar" />
